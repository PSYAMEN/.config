...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("qs -p /home/$USER/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml")    
...
hl.on("config.reloaded", function()
    hl.exec_cmd("killall rawtobar.sh waybar" )
    hl.exec_cmd("killall qs ; qs -p /home/$USER/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml")
    hl.exec_cmd("killall hyprpaper ; hypridle & hyprpaper -c ~/.config/hyprlandThemes/NoOneWillKnow/hypr/hyprpaper.conf & zsh -c 'kitty +kitten panel --config=~/.config/kitty/kittyl.conf --edge=background -o background_opacity=0 -o background=black zsh -c printf \\\"\\n\\n\\n\\\"; hyfetch; printf \\\"\\e[?25l\\\"; sleep infinity ' && powerprofilesctl set power-saver")
    ...
    hl.exec_cmd("killall awww-daemon && awww-daemon")
end)
...
hl.config({
    general = {
        ...
        layout = "dwindle",
        col = {
            active_border = { colors = { "rgba(ff9f5faa)", "rgba(ff9f5faa)", "rgba(ff9f5faa)", "rgba(5fbfffaa)", "rgba(5fbfffaa)", "rgba(5fbfffaa)" }, angle = 0 },
            inactive_border = { colors = { "rgba(ffffff66)", "rgba(88888866)", "rgba(00000066)" }, angle = 90},
        },
    },
})
...
hl.curve( "workspaces", { type = "bezier", points = { {0, 1}, {0.2, 1} } }) -- bon boing y0=1.1 y1=1.3
hl.curve( "windows", { type = "bezier", points = { {0, 1}, {0, 1} } })
hl.config({
    animations = {
        enabled = true,
    },
})
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "workspaces" })
hl.animation({ leaf = "windows",    enabled = true, speed = 3, bezier = "windows" })
hl.animation({ leaf = "fade",       enabled = true, speed = 3, bezier = "windows" })
...
hl.bind(mainMod .. " + " .. "B", hl.dsp.exec_cmd("qs -p ~/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml ipc call background makeVisible"))
hl.bind(mainMod .. " + " .. "H", hl.dsp.exec_cmd("qs -p ~/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml ipc call profileSwitcher makeVisible "))
...
hl.bind(mainMod .. " + " .. "R", hl.dsp.exec_cmd("qs -p ~/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml ipc call appLauncher makeVisible"))
...
hl.bind(mainMod .. " + " .. "F", hl.dsp.exec_cmd("qs -p ~/.config/hyprlandThemes/HollowKnight/quickshell/shell.qml ipc call appFocuser makeVisible"))
