    ...
    Rectangle {
        ...
        ColumnLayout{
            ...
            TextField {
                ...
                color:"#ffffff"
                font.family: profileSwitcher.fontFamily
                font.weight: 200
                font.pixelSize: 20
                ...
                onTextChanged: {
                    profileSwitcher.currentApps = Utils.AppSearch.fuzzyQuery(text)
                ...
                ListView{
                    ...
                    delegate: Item {
                        ...
                        Process { 
                            ...
                            running:false
                            command: [
                                themeRoot+"/HollowKnight/scripts/profile.sh", 
                                themeRoot+"/"+model.fileName
                            ]
